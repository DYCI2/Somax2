...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.084603340888407, 672.558334243297622, 245.0, 122.733334243297577 ],
					"proportion" : 0.5,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 79.860482247138407, 680.380020118491757, 51.4482421875, 19.171875 ],
					"rounded" : 8.0,
					"spacing_x" : 2.0,
					"text" : "Settings",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 784.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 151.093749970197678, 263.619793426990555, 78.239583373069763, 13.921874970197678 ],
					"rounded" : 8.0,
					"spacing_x" : 2.0,
					"text" : "Renderer",
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 739.558334243297622, 244.5, 55.733334243297577 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 732.25, 441.0, 59.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 175.279485000000022, 682.285229361789334, 35.0, 18.0 ],
					"text" : "Flush",
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 214.439112702384591, 681.285229361789334, 17.700000137090683, 17.700000137090683 ],
					"varname" : "flush"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 172.12948488973143, 681.285229361789334, 65.34296135261593, 19.200000137090683 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 672.558334243297622, 250.0, 118.733334243297577 ],
					"varname" : "somax_midioutput",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 134.0, 703.0, 211.5, 22.0 ],
					"text" : "t l 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.5, 777.0, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 134.0, 736.0, 61.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 134.0, 651.0, 75.0, 22.0 ],
					"text" : "route corpus"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "multichannelsignal", "", "", "", "", "", "" ],
					"patching_rect" : [ 383.0, 159.0, 245.0, 479.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.084603340888407, 178.824999999999989, 240.0, 487.733334243297634 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 712.0, 233.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 255.0, 798.291668486595199 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 424.785714285714278, 996.25, 767.5, 996.25 ],
					"order" : 0,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 424.785714285714278, 1000.5, 123.25, 1000.5 ],
					"order" : 1,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 392.5, 969.0, 1450.0, 969.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
