...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 281.5, 159.235987485334249, 252.0, 64.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
,
					"patching_rect" : [ 240.0, 46.0, 77.0, 22.0 ],
					"text" : "p descriptors",
					"varname" : "polyphony"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 275.0, 588.0, 207.0, 33.0 ],
									"text" : "so be sure to start the Server, and initialize any missing players"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 778.0, 403.0, 216.0, 220.0 ],
									"pic" : "atom_app.png"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 42.0, 167.0, 216.0, 220.0 ],
									"pic" : "atom_not_attached.png"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 42.0, 403.0, 216.0, 220.0 ],
									"pic" : "atom_player_not_initialized.png"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 89.0, 516.0, 20.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
,
									"text" : "To correclty initialize a somax.atom.app there are a couple of steps that needs to be understood"
								}
...
,
					"patching_rect" : [ 113.0, 46.0, 89.0, 22.0 ],
...
, 			{
				"name" : "atom_player_not_initialized.png",
				"bootpath" : "~/Documents/GitHub/Somax2/max/somax/media",
				"patcherrelativepath" : "../media",
				"type" : "PNG",
				"implicit" : 1
