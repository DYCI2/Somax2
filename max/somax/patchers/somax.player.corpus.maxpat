...
,
					"patching_rect" : [ 183.9259342977698, 595.83333333333394, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.646172291742005, 685.33333333333394, 61.0, 22.0 ],
					"text" : "setcorpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 657.646172291742005, 228.5, 51.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 701.146172291742005, 53.0, 146.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 926.312906666666777, 685.33333333333394, 88.0, 22.0 ],
					"text" : "prepend status"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 428.0, 57.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 685.33333333333394, 109.0, 22.0 ],
					"text" : "prepend getcorpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.9259342977698, 481.5, 29.5, 22.0 ],
					"text" : "-1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 24.0, 529.0, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 481.5, 94.0, 22.0 ],
					"text" : "v #0_corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.323086196503937, 53.0, 94.0, 20.0 ],
					"text" : "user messages"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 184.323086196503937, 138.0, 328.000000000000909, 22.0 ],
					"text" : "route setcorpus refresh getcorpus volatile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 657.646240000000034, 138.0, 422.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1265.720238095238074, 77.5, 211.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1237.623086196503664, 685.33333333333394, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 736.720238095238074, 595.83333333333394, 86.0, 33.0 ],
...
,
					"patching_rect" : [ 791.979573333333406, 292.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1237.791550665434897, 48.0, 83.0, 20.0 ],
					"text" : "global receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.646172291742005, 202.0, 117.0, 22.0 ],
					"text" : "v #0_corpustype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.646172291742005, 258.5, 94.0, 22.0 ],
					"text" : "v #0_corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 657.646172291742005, 171.873238848713299, 51.0, 22.0 ],
					"text" : "unjoin 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.9259342977698, 685.33333333333394, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "", "", "" ],
					"patching_rect" : [ 1119.123086196503664, 77.5, 137.5, 22.0 ],
					"text" : "t b s s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 379.823086196504391, 640.83333333333394, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1119.123086196503664, 48.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.623086196503664, 685.33333333333394, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 542.623086196503664, 685.33333333333394, 87.0, 22.0 ],
					"text" : "refreshcorpora"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 379.823086196504391, 595.83333333333394, 181.799999999999272, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.9259342977698, 560.5, 43.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 229.9259342977698, 558.5, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.9259342977698, 560.5, 49.799999999999727, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.9259342977698, 516.5, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 184.323086196503937, 422.0, 214.500000000000455, 43.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 261.573086196504164, 349.5, 51.0, 22.0 ],
					"text" : "t b clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 183.9259342977698, 490.5, 77.0, 22.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.322998000000098, 48.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.646240000000034, 48.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.323086196503937, 764.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 348.323086196504391, 296.5, 33.5, 296.5 ],
					"source" : [ "obj-1052", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 425.573086196504619, 546.75, 239.4259342977698, 546.75 ],
					"source" : [ "obj-1052", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1088", 0 ],
					"midpoints" : [ 935.812906666666777, 748.5, 33.5, 748.5 ],
					"source" : [ "obj-1084", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 883.479573333333406, 406.5, 291.573086196504164, 406.5 ],
					"source" : [ "obj-1226", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-349", 0 ],
					"midpoints" : [ 801.479573333333406, 384.5, 193.823086196503937, 384.5 ],
					"source" : [ "obj-1226", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1088", 0 ],
					"midpoints" : [ 1247.123086196503664, 749.25, 33.5, 749.25 ],
					"source" : [ "obj-1229", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-349", 0 ],
					"midpoints" : [ 271.073086196504164, 385.25, 193.823086196503937, 385.25 ],
					"source" : [ "obj-214", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1207.623086196503664, 625.66666666666697, 408.323086196504391, 625.66666666666697 ],
					"source" : [ "obj-23", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1168.123086196503664, 586.16666666666697, 285.4259342977698, 586.16666666666697 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-214", 0 ],
					"midpoints" : [ 1128.623086196503664, 336.0, 271.073086196504164, 336.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1088", 0 ],
					"midpoints" : [ 552.123086196503664, 748.16666666666697, 33.5, 748.16666666666697 ],
					"source" : [ "obj-499", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1088", 0 ],
					"midpoints" : [ 667.146172291742005, 749.5, 33.5, 749.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1090", 0 ],
					"midpoints" : [ 389.123086196503664, 721.66666666666697, 193.823086196503937, 721.66666666666697 ],
					"source" : [ "obj-912", 0 ]
				}
