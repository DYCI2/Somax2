...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
							"parameter_longname" : "transpositions[5]",
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"__exp_melodicpitchfromchords" : [ "Bass note" ],
						...
						"outputthreshold" : [ 0.457203480228511 ],
						"playingmode" : [ 1 ],
						"pollpeaks" : [ 1 ],
						"recombine" : [ 0 ],
						"regionmask" : [ 0.084056581634103, 0.094701513821734 ],
						"regionmaskenable" : [ 0 ],
						"reinstantiate" : [ 1.0 ],
						"resetinfluences" : [ 0.0 ],
						"resetparams" : [ 0.0 ],
