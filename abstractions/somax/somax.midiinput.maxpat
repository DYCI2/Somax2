...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 203.694839102912283, 45.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 632.946543508926879, 51.0, 346.757575757575751, 22.0 ],
					"text" : "route enabled device channnel flush"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.25, 45.0, 56.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 219.0, 56.0, 18.0 ],
					"text" : "Enabled",
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 216.0, 57.0, 21.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.25, 663.0, 115.0, 22.0 ],
					"text" : "pack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.25, 561.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 202.25, 600.0, 67.0, 22.0 ],
					"text" : "flush"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 202.25, 561.0, 67.0, 22.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.499999821186066, 45.0, 195.200000941753387, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 181.194839102912283, 4.0, 32.399999856948853, 20.0 ],
					"text" : "omni",
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 167.694839102912283, 26.0, 68.5, 18.0 ],
					"text" : "Channel",
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 209.294839186358786, 9.0, 26.399999916553497, 10.0 ],
					"size" : 16.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 169.694839102912283, 4.0, 32.0, 20.0 ],
					"textcolor" : [ 0.933333333333333, 0.933333333333333, 0.933333333333333, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.25, 212.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 266.5, 43.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 167.694839102912283, 2.0, 69.0, 24.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.5, 154.0, 77.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 467.446543508926879, 604.138956516981125, 307.75, 604.138956516981125 ],
					"source" : [ "obj-119", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 259.75, 628.0, 470.0, 628.0 ],
					"order" : 0,
					"source" : [ "obj-86", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 211.75, 642.0, 351.75, 642.0 ],
					"order" : 0,
					"source" : [ "obj-86", 0 ]
				}
