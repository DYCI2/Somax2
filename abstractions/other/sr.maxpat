		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 374.0, 302.0, 173.0, 90.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "", "" ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "nogrow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 374, 302, 547, 392, ";", "#Q", "window", "notitle", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ]
								}
