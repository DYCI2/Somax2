...
, 							{
								"box" : 								{
									...
									"text" : "The main role of the somax.audio.io object is to analyze and segment an incoming signal with respect to pitch, chroma and onset. Or in fact, this is the role of the somax.audioinfluencer object, the somax.audio.io object is just a convenient wrapper around the former, with some additional user interface to handle the audio inputs and outputs. In addition, all influences generated by the somax.audio.io are sent wirelessly to any related somax.player.",
